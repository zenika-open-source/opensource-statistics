package io.github.opensource.stats.ui;
...
import io.github.opensource.stats.ui.tabs.ContributionsTab;
import io.github.opensource.stats.ui.tabs.MembersTab;
import io.github.opensource.stats.ui.tabs.ProjectsTab;
import io.github.opensource.stats.ui.tabs.OrganizationProjectsTab;
import io.github.opensource.stats.ui.tabs.StatsTab;
...
public class JavelitDashboard {
    ...
    void onStart(@Observes StartupEvent ev) {
        Server.builder(() -> {
            ...
            var tabs = Jt.tabs(List.of("🙋 Members", "🚀 Members Projects", "🏢 " + organizationDisplayName + " Open Source Projects",
