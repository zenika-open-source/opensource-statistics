...
public class StatsTab {
    ...
    public void render(JtContainer statsTab) {
        try {
            ...
            try {
                List<io.github.opensource.stats.beans.Project> allProjects = firestoreServices.getAllProjects();
                ...
                if (!allProjects.isEmpty()) {
                    ...
                    if (!topOrgProjects.isEmpty()) {
                        Jt.subheader("🏆 Top 3 " + organizationDisplayName + " Open Source Projects by Stars").use(statsTab);
