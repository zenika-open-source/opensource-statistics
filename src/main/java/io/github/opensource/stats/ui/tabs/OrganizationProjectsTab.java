...
public class OrganizationProjectsTab {
    ...
    public void render(JtContainer projectsTab) {
        try {
            ...
            Jt.subheader(organizationDisplayName + " Projects (" + organizationProjects.size() + ")").use(columns.col(0));

            if (Jt.button("🚀 Sync " + organizationDisplayName + " Organization Projects").use(columns.col(1))) {
                try {
                    ...
                    Jt.success("Successfully synced " + totalProjects + " projects for " + organizationDisplayName
                            + " organization!")
                            .use(projectsTab);
